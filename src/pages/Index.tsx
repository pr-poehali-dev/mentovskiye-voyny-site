...
const Index = () => {
  ...
  const mainCharacters = [
    { name: 'Александр Устюгов', role: 'Роман Георгиевич Шилов', seasons: '1-11' },
    { name: 'Дмитрий Быковский-Ромашов', role: 'Евгений Егорович Иванов (Джексон)', seasons: '1-10' },
    { name: 'Всеволод Цурило', role: 'Павел Николаевич Арнаутов', seasons: '1-11' },
    { name: 'Александр Лисицын', role: 'Николай Иванович Арнаутов', seasons: '1-8, 10' },
    { name: 'Марина Игнатова', role: 'Татьяна Николаевна Кожурина', seasons: '1-7, 10' },
    { name: 'Леонид Осокин', role: 'Юрий Голицын', seasons: '1-4' },
    { name: 'Сергей Кудрявцев', role: 'Виктор Петрович Егоров', seasons: '1-3' },
    { name: 'Роман Громадский', role: 'Максим Викторович Герасимов', seasons: '1-7' },
  ];

  const actors = [
    'Александр Устюгов', 'Дмитрий Быковский-Ромашов', 'Всеволод Цурило', 'Александр Лисицын', 
    'Марина Игнатова', 'Леонид Осокин', 'Сергей Кудрявцев', 'Роман Громадский',
    'Владимир Рублёв', 'Кирилл Таскин', 'Виталий Такс', 'Юрий Елагин',
    'Анна Мишина-Васькова', 'Игорь Волков', 'Георгий Пицхелаури', 'Лаура Пицхелаури',
    'Игорь Головин', 'Валерий Малюшин', 'Сергей Кузнецов', 'Владимир Сапунков',
    'Руслан Ибрагимов', 'Вадим Бочанов', 'Сергей Перегудов', 'Николай Горшков', 'Вадим Романов'
  ];
